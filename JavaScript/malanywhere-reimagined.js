...
function malanywhereVerifyCredentials(username, password) {
    $.ajax({
...
function malanywhereGetInfo(titles, username, password) {
    if (malanywhereVerifyCredentials(username, password)) {
...
function malanywhereAdd(xmlValues, username, password) {

}

function malanywhereUpdate(xmlValues, username, password) {

}

function malanywhereDelete(id, username, password) {
